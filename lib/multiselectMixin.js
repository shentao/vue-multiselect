...
function filterOptions(options, search, label) {
  return label ? options.filter(function (option) {
    return includes(removeDiacritics(option[label]), search);
  }) : options.filter(function (option) {
    return includes(removeDiacritics(option), search);
  });
}
...
module.exports = {
  ...
  computed: {
    filteredOptions: function filteredOptions() {
      ...
      var normalizedSearch = removeDiacritics(search.toLowerCase());
