...
exports.default = {
  ...
  computed: {
    ...
    currentOptionLabel: function currentOptionLabel() {
      return this.multiple ? this.hideTagList && this.internalValue.length ? this.placeholder + ' (' + this.internalValue.length + ')' : this.searchable ? '' : this.placeholder : this.internalValue.length ? this.getOptionLabel(this.internalValue[0]) : this.searchable ? '' : this.placeholder;
    },
