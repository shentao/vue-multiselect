  ...
  methods: {
    ...
    pointerForward: function pointerForward() {
      if (this.pointer < this.filteredOptions.length - 1) {
        ...
        if (this.filteredOptions[this.pointer] && this.filteredOptions[this.pointer].$isLabel) this.pointerForward();
      }
    ...
    pointerBackward: function pointerBackward() {
      if (this.pointer > 0) {
        ...
        if (this.filteredOptions[this.pointer] && this.filteredOptions[this.pointer].$isLabel) this.pointerBackward();
      } else {
        if (this.filteredOptions[0] && this.filteredOptions[0].$isLabel) this.pointerForward();
      }
      this.pointerDirty = true;
    },
